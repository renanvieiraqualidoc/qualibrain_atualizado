<div class="modal" id="totalprodutosmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<script language='javascript'>
    function populateData(data) {
        ...
        $('#dataTable').DataTable().destroy(); // Destrói os dados da tabela anterior
